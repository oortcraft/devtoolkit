...
- [The Algorithm Behind git diff: How Myers Diff Works](/blog/myers-diff-algorithm) — a deep dive into the algorithm that powers the diffs you see every day
- [Regex Cheat Sheet for Developers](/blog/regex-cheat-sheet) — another essential text processing tool for pattern matching and extraction
