...
- [Common Regex Patterns: 20+ Examples](/blog/common-regex-patterns) — production-ready patterns for URLs, emails, dates, and more
- [Regex for Email Validation: Patterns That Actually Work](/blog/regex-email-validation) — the right way to validate emails with regex
- [Text Diff Algorithms Explained](/blog/text-diff-explained) — another powerful text processing technique every developer should know
